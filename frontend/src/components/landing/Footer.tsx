    ...
    <footer>
      <div className="wrap">
        <div className="footer-grid">
          ...
          <div>
            ...
            <ul>
              ...
              <li><a href="#about">Pastorale nationale</a></li>
            </ul>
          </div>
          ...
          <div>
            <h6>Contact</h6>
            <ul>
              <li><a href="mailto:secretariat@eec-cameroun.org">Bureau national</a></li>
        ...
        <div className="footer-bottom">
          <span>© 2026 ÉGLISE ÉVANGÉLIQUE DU CAMEROUN — Bureau national</span>
